        ...
        {isOrderReceived ? (
          ...
          <div className={styles.checkoutSection}>
            ...
            <div className={styles.inputGroup}>
              ...
              <input type="text" id="address" placeholder="Ataturk 45 Ganclik Baku" />
            </div>
            <div className={styles.inputGroup}>
            ...
            <div className={styles.paymentMethod}>
              ...
              <div className={styles.radioGroup}>
                <label className={styles.radioLabel}>
                  <input type="radio" name="payment" value="door" defaultChecked />
                  <span className={styles.radioText}>pay at the door</span>
                </label>
                <label className={styles.radioLabel}>
                  <input type="radio" name="payment" value="creditCard" />
                  <span className={styles.radioText}>pay at the door by credit card</span>
                </label>
              </div>
            </div>
